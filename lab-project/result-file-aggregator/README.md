...
```bash
cd result-file-aggregator
python result_file_aggregator.py
```
...
| 2 | `Output file path` | `output_result_file_aggregator.txt` |
...
Output file path [默认: output_result_file_aggregator.txt]: 
