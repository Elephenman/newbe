...
Markdown到reveal.js幻灯片转换 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_markdown_to_slides_converter.txt |
...
```bash
# Python工具
cd markdown-to-slides-converter
python markdown_to_slides_converter.py

# R工具
cd markdown-to-slides-converter
Rscript markdown_to_slides_converter.py
```
