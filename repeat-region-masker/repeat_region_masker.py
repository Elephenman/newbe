...
def main():
    ...
    output_file = get_input("Output file path", "output_repeat_region_masker.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for repeat_region_masker\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# repeat_region_masker output\n")
