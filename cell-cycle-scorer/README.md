...
单细胞周期评分+G1/S/G2M分类 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_cell_cycle_scorer.txt |
...
```bash
# Python工具
cd cell-cycle-scorer
python cell_cycle_scorer.R

# R工具
cd cell-cycle-scorer
Rscript cell_cycle_scorer.R
```
