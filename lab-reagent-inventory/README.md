...
实验室试剂库存管理+过期预警 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_lab_reagent_inventory.txt |
...
```bash
# Python工具
cd lab-reagent-inventory
python lab_reagent_inventory.py

# R工具
cd lab-reagent-inventory
Rscript lab_reagent_inventory.py
```
