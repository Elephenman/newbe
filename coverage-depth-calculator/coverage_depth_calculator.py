...
def main():
    print("=" * 60)
    print("  BAM覆盖深度统计+区间分布")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_coverage_depth_calculator.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for coverage_depth_calculator\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# coverage_depth_calculator output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] coverage_depth_calculator completed successfully!")
