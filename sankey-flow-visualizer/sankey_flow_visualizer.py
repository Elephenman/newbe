...
def main():
    ...
    output_file = get_input("Output file path", "output_sankey_flow_visualizer.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for sankey_flow_visualizer\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# sankey_flow_visualizer output\n")
