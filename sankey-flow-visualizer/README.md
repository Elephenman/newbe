...
Sankey流向图（数据通路/样本流转） — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_sankey_flow_visualizer.txt |
...
```bash
# Python工具
cd sankey-flow-visualizer
python sankey_flow_visualizer.py

# R工具
cd sankey-flow-visualizer
Rscript sankey_flow_visualizer.py
```
