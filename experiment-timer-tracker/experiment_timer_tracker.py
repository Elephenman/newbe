...
def main():
    print("=" * 60)
    print("  实验时间记录+耗时统计+效率报告")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_experiment_timer_tracker.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for experiment_timer_tracker\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# experiment_timer_tracker output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] experiment_timer_tracker completed successfully!")
