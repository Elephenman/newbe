...
def main():
    ...
    output_file = get_input("Output file path", "output_somatic_mutation_filter.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for somatic_mutation_filter\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# somatic_mutation_filter output\n")
