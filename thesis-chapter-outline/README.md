...
学位论文章节大纲生成+进度追踪 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_thesis_chapter_outline.txt |
...
```bash
# Python工具
cd thesis-chapter-outline
python thesis_chapter_outline.py

# R工具
cd thesis-chapter-outline
Rscript thesis_chapter_outline.py
```
