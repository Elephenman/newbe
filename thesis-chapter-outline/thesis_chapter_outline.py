...
def main():
    ...
    output_file = get_input("Output file path", "output_thesis_chapter_outline.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for thesis_chapter_outline\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# thesis_chapter_outline output\n")
