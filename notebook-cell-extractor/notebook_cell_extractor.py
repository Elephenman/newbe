...
def main():
    ...
    output_file = get_input("Output file path", "output_notebook_cell_extractor.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for notebook_cell_extractor\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# notebook_cell_extractor output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] notebook_cell_extractor completed successfully!")
