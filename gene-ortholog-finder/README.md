...
跨物种同源基因查找+进化树构建 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_gene_ortholog_finder.txt |
...
```bash
# Python工具
cd gene-ortholog-finder
python gene_ortholog_finder.py

# R工具
cd gene-ortholog-finder
Rscript gene_ortholog_finder.py
```
