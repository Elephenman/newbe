...
def main():
    print("=" * 60)
    print("  ATAC-seq peak最近基因+调控元件注释")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_atac_peak_annotator.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for atac_peak_annotator\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# atac_peak_annotator output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] atac_peak_annotator completed successfully!")
