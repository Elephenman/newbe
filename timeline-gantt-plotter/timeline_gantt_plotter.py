...
def main():
    ...
    output_file = get_input("Output file path", "output_timeline_gantt_plotter.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for timeline_gantt_plotter\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# timeline_gantt_plotter output\n")
