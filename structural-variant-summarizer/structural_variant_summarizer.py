...
def main():
    ...
    output_file = get_input("Output file path", "output_structural_variant_summarizer.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for structural_variant_summarizer\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# structural_variant_summarizer output\n")
