...
```bash
cd atac-peak-annotator
python atac_peak_annotator.py
```
...
| 2 | `Output file path` | `output_atac_peak_annotator.txt` |
...
Output file path [默认: output_atac_peak_annotator.txt]: 
