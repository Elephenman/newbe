...
def main():
    ...
    output_file = get_input("Output file path", "output_hi_c_contact_mapper.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for hi_c_contact_mapper\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# hi_c_contact_mapper output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] hi_c_contact_mapper completed successfully!")
