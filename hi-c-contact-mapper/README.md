...
Hi-C接触矩阵可视化+TAD标注 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_hi_c_contact_mapper.txt |
...
```bash
# Python工具
cd hi-c-contact-mapper
python hi_c_contact_mapper.py

# R工具
cd hi-c-contact-mapper
Rscript hi_c_contact_mapper.py
```
