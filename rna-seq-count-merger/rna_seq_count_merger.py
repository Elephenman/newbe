...
def main():
    ...
    output_file = get_input("Output file path", "output_rna_seq_count_merger.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for rna_seq_count_merger\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# rna_seq_count_merger output\n")
