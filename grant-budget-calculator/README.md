...
基金预算自动计算+分项汇总 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_grant_budget_calculator.txt |
...
```bash
# Python工具
cd grant-budget-calculator
python grant_budget_calculator.py

# R工具
cd grant-budget-calculator
Rscript grant_budget_calculator.py
```
