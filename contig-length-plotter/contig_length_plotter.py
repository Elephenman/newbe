...
def main():
    print("=" * 60)
    print("  组装contig/N50统计+长度分布图")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_contig_length_plotter.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for contig_length_plotter\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# contig_length_plotter output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] contig_length_plotter completed successfully!")
