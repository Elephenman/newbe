...
def main():
    print("=" * 60)
    print("  CSV/TSV/JSON/Excel格式互转")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_data_type_converter.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for data_type_converter\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# data_type_converter output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] data_type_converter completed successfully!")
