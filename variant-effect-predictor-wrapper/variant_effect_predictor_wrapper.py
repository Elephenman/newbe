...
def main():
    ...
    output_file = get_input("Output file path", "output_variant_effect_predictor_wrapper.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for variant_effect_predictor_wrapper\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# variant_effect_predictor_wrapper output\n")
