...
def main():
    print("=" * 60)
    print("  ChIP-seq peak合并+共有peak提取")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_chip_seq_peak_merger.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for chip_seq_peak_merger\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# chip_seq_peak_merger output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] chip_seq_peak_merger completed successfully!")
