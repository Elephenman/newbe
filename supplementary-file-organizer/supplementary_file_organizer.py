...
def main():
    ...
    output_file = get_input("Output file path", "output_supplementary_file_organizer.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for supplementary_file_organizer\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# supplementary_file_organizer output\n")
