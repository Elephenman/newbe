...
def main():
    ...
    output_file = get_input("Output file path", "output_lab_meeting_minute_generator.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for lab_meeting_minute_generator\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# lab_meeting_minute_generator output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] lab_meeting_minute_generator completed successfully!")
