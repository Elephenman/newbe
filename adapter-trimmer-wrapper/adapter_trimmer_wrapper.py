...
def main():
    print("=" * 60)
    print("  FASTQ adapter序列检测+修剪报告")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_adapter_trimmer_wrapper.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for adapter_trimmer_wrapper\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# adapter_trimmer_wrapper output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] adapter_trimmer_wrapper completed successfully!")
