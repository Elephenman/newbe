...
def main():
    ...
    output_file = get_input("Output file path", "output_genome_size_estimator.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for genome_size_estimator\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# genome_size_estimator output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] genome_size_estimator completed successfully!")
