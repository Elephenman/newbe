...
def main():
    ...
    output_file = get_input("Output file path", "output_figure_caption_extractor.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for figure_caption_extractor\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# figure_caption_extractor output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] figure_caption_extractor completed successfully!")
