...
论文图表标题批量提取+编号校验 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_figure_caption_extractor.txt |
...
```bash
# Python工具
cd figure-caption-extractor
python figure_caption_extractor.py

# R工具
cd figure-caption-extractor
Rscript figure_caption_extractor.py
```
