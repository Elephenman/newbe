...
def main():
    print("=" * 60)
    print("  会议摘要格式化+字数合规检查")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_conference_abstract_formatter.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for conference_abstract_formatter\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# conference_abstract_formatter output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] conference_abstract_formatter completed successfully!")
