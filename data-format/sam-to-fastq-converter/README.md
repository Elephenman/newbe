...
```bash
cd sam-to-fastq-converter
python sam_to_fastq_converter.py
```
...
| 2 | `Output file path` | `output_sam_to_fastq_converter.txt` |
...
Output file path [默认: output_sam_to_fastq_converter.txt]: 
