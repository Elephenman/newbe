...
def main():
    print("=" * 60)
    print("  密码子使用偏性分析+RSCU/CAI计算")
    print("=" * 60)
    print()

    # === Input Parameters ===
    input_file = get_input("Input file path", "input.txt")
    output_file = get_input("Output file path", "output_codon_usage_analyzer.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for codon_usage_analyzer\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# codon_usage_analyzer output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] codon_usage_analyzer completed successfully!")
