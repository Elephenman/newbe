...
def main():
    ...
    output_file = get_input("Output file path", "output_protein_domain_mapper.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for protein_domain_mapper\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# protein_domain_mapper output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] protein_domain_mapper completed successfully!")
