...
论文逐章节字数统计+合规检查 — 针对浙大生信研究生+陆慧智课题组（DNA损伤修复）方向优化。
...
| output_file | 输出文件路径 | output_manuscript_word_counter.txt |
...
```bash
# Python工具
cd manuscript-word-counter
python manuscript_word_counter.py

# R工具
cd manuscript-word-counter
Rscript manuscript_word_counter.py
```
