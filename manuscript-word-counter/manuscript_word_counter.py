...
def main():
    ...
    output_file = get_input("Output file path", "output_manuscript_word_counter.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for manuscript_word_counter\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# manuscript_word_counter output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] manuscript_word_counter completed successfully!")
