...
def main():
    ...
    output_file = get_input("Output file path", "output_volcano_plot_enhancer.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for volcano_plot_enhancer\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# volcano_plot_enhancer output\n")
