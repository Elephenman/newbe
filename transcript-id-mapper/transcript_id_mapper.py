...
def main():
    ...
    output_file = get_input("Output file path", "output_transcript_id_mapper.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for transcript_id_mapper\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# transcript_id_mapper output\n")
