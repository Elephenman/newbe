...
def main():
    ...
    output_file = get_input("Output file path", "output_stats_summary_table_maker.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for stats_summary_table_maker\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# stats_summary_table_maker output\n")
