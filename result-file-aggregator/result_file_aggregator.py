...
def main():
    ...
    output_file = get_input("Output file path", "output_result_file_aggregator.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for result_file_aggregator\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# result_file_aggregator output\n")
