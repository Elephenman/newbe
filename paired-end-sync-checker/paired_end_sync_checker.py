...
def main():
    ...
    output_file = get_input("Output file path", "output_paired_end_sync_checker.txt")
    ...
    if not os.path.exists(input_file):
        ...
        with open(input_file, "w") as f:
            f.write("# Demo input file for paired_end_sync_checker\n")
    ...
    try:
        with open(output_file, "w") as f:
            f.write("# paired_end_sync_checker output\n")
    ...
    print("=" * 60)
    print()
    print("[Done] paired_end_sync_checker completed successfully!")
